...
from app.models.models import Session as SessionModel  # ✅ updated import here
...
def run_pipeline(job_desc: str, pdf_paths: List[str]) -> List[dict]:
    results = []
...
async def compare(
    ...
    results = run_pipeline(job_description, full_pdf_paths)
